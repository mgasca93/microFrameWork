    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-5">
                <h1 class="display-1 text-center font-weight-light mt-5"><i class="fas fa-bomb"></i></h1>
                <h1 class="display-1 text-center font-weight-light mt-1">404</h1>
                <p class="text-center font-weight-light">Page Not Found</p>
            </div>
        </div>
    </div>
